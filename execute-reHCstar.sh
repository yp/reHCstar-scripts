...
if [ ! -x "${reHC_exe}" ]; then echo "Main program '${reHC_exe}' not found or not executable. Aborting..."; exit 1; fi
...
reHC_partial="${reHC_exe} ${reHC_sat_mode} ${error_handler} ${recomb_handler}"
